...
For some use cases (dealing with long text), it performs **10^4** faster than both native and `fast-json-stringify`.
In more standard use cases the performance improvement is varying between **20%-400%**.
